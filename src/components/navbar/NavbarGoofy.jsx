...
const NavbarGoofy = (props) => {
  ...
  return (
    <>
      ...
      >
        <Link to="/goofy" className="flex cursor-pointer">
          ...
          <div
            className={`transition-all duration-300
                ...
                ${isScale ? "opacity-100" : ""}`}
          >
            <span className={`font-normal ml-3`} style={{ textWrap: 'nowrap' }}>&nbsp;&nbsp;Goofy Gophers</span>
          </div>
        </Link>
      </div>
    </>
