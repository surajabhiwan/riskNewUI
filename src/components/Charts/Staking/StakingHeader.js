    ...
    <div
      ...
      <div className="flex flex-col justify-center gap-3 w-1/5 bg-[#0b1217] rounded-xl p-3">
        <div className="flex justify-between">
          <p className="text-[#9f9fa8] font-normal text-sm">Supply Staked
          </p>
        </div>
        <div className="flex justify-start">
          <p className="text-white font-normal text-lg">6.06 M ₳(0.01%)SNEK
          </p>
        </div>
      </div>
      {/* Part 2 */}
      <div className="flex flex-col justify-center gap-3 w-1/5 bg-[#0b1217] rounded-xl p-3">
        <div className="flex justify-between">
          <p className="text-[#9f9fa8] font-normal text-sm">Number of Stakers
          </p>
        </div>
        <div className="flex justify-start">
          <p className="text-white font-normal text-lg">9
          </p>
        </div>
      </div>
      {/* Part 3 */}
      <div className="flex flex-col justify-center gap-3 w-1/5 bg-[#0b1217] rounded-xl p-3">
        <div className="flex justify-between items-center w-full">
          <p className="text-[#9f9fa8] text-sm inline-block whitespace-normal overflow-hidden text-ellipsis">Supply Staked/Unstaked</p>
        </div>
        <div className=" flex flex-col justify-center gap-2">
          <div className="flex justify-between ">
            <p className="text-yellow-400 font-normal text-sm">22
            </p>
            <p className="text-red-400 font-normal text-sm">78
            </p>
          </div>
