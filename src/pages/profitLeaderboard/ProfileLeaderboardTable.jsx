...
import { TotalVolumeTradedData } from "../../components/Pro/LandingData/TotalVolumeTraded";
import Pagination from "../../components/Pro/HotWalletsLanding/Pagination";

const ProfileLeaderboardTable = () => {
  const [totalVolumeTradedData, setTotalVolumeTradedData] = useState(TotalVolumeTradedData);
  const [totalVolumeTradedDataItems, setTotalVolumeTradedDataItems] = useState(totalVolumeTradedData.ItemValue);
...
export default ProfileLeaderboardTable;
