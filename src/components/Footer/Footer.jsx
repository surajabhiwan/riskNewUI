...
const Footer = () => {
  ...
  return (
    <div className="footerOuterDiv py-10">
      <div className="footerLeft">
        <div className="logoDiv scale-75 lg:scale-100">
        ...
        <div className="SocialDiv">
          <a
            href="https://discord.gg/riskgaming"
            target="_blank"
            rel="noopener noreferrer"
          >
            <RiDiscordFill style={{ fontSize: "1.5rem" }} />
          </a>
          <a
            href="https://twitter.com/riskgamingco"
            target="_blank"
            rel="noopener noreferrer"
          >
    ...
    <div className="linksContainer">
      <div className="linksGroup">
        <ul className="linksList">
          <li onClick={() => handleClickLinks("/")}>Home</li>
          <li onClick={() => handleClickLinks("/bubbles")}>Bubbles</li>
          <li onClick={() => handleClickLinks("/portfolio")}>Portfolio</li>
        </ul>
      </div>
      <div className="linksGroup">
        <ul className="linksList">
          <li onClick={() => handleClickLinks("/charts")}>Charts</li>
          {/* <li onClick={() => handleClickLinks('/marketplace')}>Marketplace</li>
          <li onClick={() => handleClickLinks('/mining')}>Mining</li> */}
        </ul>
      </div>
    </div>
  </div>
